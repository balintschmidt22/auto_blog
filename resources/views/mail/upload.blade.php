                                      ...
                                      <tbody>
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                            <h1 class="h3" style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="left">Hi {{$user['username']}}!</h1>
                                            ...
                                            <h5 class="text-teal-700" style="color: #13795b; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;" align="left">An image has been uploaded by {{App\Models\User::find($image['user_id'])['username']}} at {{$image['created_at']}}</h5>
                                            ...
                                            <div class="space-y-3">
                                              <p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;" align="left">{{$image->brand()['name']}} {{$image->type()->get()->first()['type']}}</p>
                                              <p><img src="{{ $message->embed(public_path() . "/storage/" . $image['image']) }}" style="width: 200px; border: solid 1px black;"></p>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td style="line-height: 24px; font-size: 16px; border-radius: 6px; margin: 0;" align="center" bgcolor="#0d6efd">
                                                    <a href="http://localhost:8000/gallery/{{$image['id']}}" target="_blank" style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #0d6efd; padding: 8px 12px; border: 1px solid #0d6efd;">View the new post</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
